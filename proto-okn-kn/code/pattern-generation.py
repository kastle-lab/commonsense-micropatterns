...
#  Directories
input_path = "./proto-okn-kn/prompt-results"
output_path = "./proto-okn-kn/extracted-patterns"
analysis_path = "./proto-okn-kn/pattern-analysis"
pattern_path = "./proto-okn-kn/patterns"
