...
#  Directories
input_path = "../key-notions/prompt-results"
output_path = "../key-notions/extracted-patterns"
analysis_path = "../key-notions/pattern-analysis"
pattern_path = "../key-notions/patterns"
...
def parse_results(verbose=False):
    ...
    for result_file in result_files:
        ...
        if(not os.path.exists(key_notions_dir)): 
            ...
            print(f"\tCreating firectory: {key_notions_dir}")
...
def vote_properties(verbose=False):
    ...
    with open(analysis_filepath, "w") as stats_file: 
        ...
        for key_notions_filepath in key_notions_filepaths: # For each key_notions
            ...
            key_notions_dir = os.path.join(output_path, key_notions)
